float ADCMeasurements() {
  ...
  while (new_time - old_time <= 20000) { // Measuring each 1/50 s = 20000 us
    for (int i = 0; i <= 100; i++) {
      voltage_1[i] = (analogRead(4) * 325.27) / 4095; //ADC Read for V1
      voltage_2[i] = (analogRead(5) * 325.27) / 4095; //ADC Read for V2
      voltage_3[i] = (analogRead(6) * 325.27) / 4095; //ADC Read for V3
